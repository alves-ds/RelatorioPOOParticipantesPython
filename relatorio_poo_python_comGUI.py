...
class ProcessaAcelerometro():
    ...
    def __init__(self):
        ...
        self.dias_da_semana = ['Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'Sábado',
                               'Domingo']
    ...
    def TelaInicial(self):
        ...
        img = customtkinter.CTkImage(Image.open("img_relatorio3.jpg"), size=(350, 400))
        label_img = customtkinter.CTkLabel(master=janela_input, text="", image=img)
        label_img.pack(padx=0, pady=25)

        texto_id = customtkinter.CTkLabel(frame, text='Insira o ID do usuário abaixo')
        texto_id.pack(padx=20, pady=10)
        ID = customtkinter.CTkEntry(frame, placeholder_text='ex: 738')
        ID.pack(padx=10, pady=10)
        texto_data_inicio = customtkinter.CTkLabel(frame,
                                                   text='Insira a data de início do monitoramento abaixo')
        texto_data_inicio.pack(padx=30, pady=10)
        data_inicio_monitoramento = customtkinter.CTkEntry(frame,
                                                           placeholder_text='ex: 2023-08-07')

        data_inicio_monitoramento.pack(padx=10, pady=10)

        texto_data_fim = customtkinter.CTkLabel(frame,
                                                text='Insira a data de fim do monitoramento abaixo')
        texto_data_fim.pack(padx=20, pady=10)
        data_fim_monitoramento = customtkinter.CTkEntry(frame, placeholder_text='ex: 2023-09-10')
    ...
    def FiltrarDadosData(self):
        ...
        print('Dados filtrados com sucesso, correspondentes ao período de ' + str(self.data_inicio) + ' e ' + str(
            self.data_final))
    ...
    def CriarGrafico_DiarioFleem(self):
        ...
        ax[0].plot(self.dias_da_semana, self.leve_sem1, color='#228B22', linestyle='--', marker='o', markersize=4,
                   label='Leve')
        ax[0].plot(self.dias_da_semana, self.moderada_sem1, color='#FF8C00', linestyle='--', marker='o', markersize=4,
                   label='Moderada')
        ax[0].plot(self.dias_da_semana, self.vigorosa_sem1, color='#FF0000', linestyle='--', marker='o', markersize=4,
                   label='Vigorosa')
        ax[0].set_title('Semana 1 ' + str(self.sem1['Date'].iloc[0]) + ' à' + str(self.sem1['Date'].iloc[-1]),
                        fontsize=12)
        ...
        ax[1].set_title('Semana 2 ' + str(self.sem2['Date'].iloc[0]) + ' à' + str(self.sem2['Date'].iloc[-1]),
                        fontsize=12)
        ...
        ax[2].set_title('Semana 3 ' + str(self.sem3['Date'].iloc[0]) + ' à' + str(self.sem3['Date'].iloc[-1]),
                        fontsize=12)
        ...
        ax[3].set_title('Semana 4 ' + str(self.sem4['Date'].iloc[0]) + ' à' + str(self.sem4['Date'].iloc[-1]),
                        fontsize=12)
        ...
        ax[4].set_title('Semana 5 ' + str(self.sem5['Date'].iloc[0]) + ' à' + str(self.sem5['Date'].iloc[-1]),
                        fontsize=12)
    ...
    def CriarGrafico_SemanalFleem(self):
        ...
        plt.plot(self.semanas, self.af_leve_5_semanas, color='#228B22', linestyle='--', marker='o', markersize=4,
                 label='Leve')
        plt.plot(self.semanas, self.af_moderada_5_semanas, color='#FF8C00', linestyle='--', marker='o', markersize=4,
                 label='Moderada')
        plt.plot(self.semanas, self.af_vigorosa_5_semanas, color='#FF0000', linestyle='--', marker='o', markersize=4,
                 label='Vigorosa')
    ...
    def ProcessarDadosIpaq(self):
        ...
        af_remunerada_5_semanas_ipaq_tup_dom = (
        af_remunerada_1, af_remunerada_2, af_remunerada_3, af_remunerada_4, af_remunerada_5)
        ...
        af_transporte_5_semanas_ipaq_tup_dom = (
        af_transporte_1, af_transporte_2, af_transporte_3, af_transporte_4, af_transporte_5)
        ...
        af_domestica_5_semanas_ipaq_tup_dom = (
        af_domestica_1, af_domestica_2, af_domestica_3, af_domestica_4, af_domestica_5)
    ...
    def CriarGrafico_SemanalIpaq(self):
        ...
        plt.plot(self.semanas, self.af_leve_5_semanas_ipaq, color='#228B22', linestyle='--', marker='o', markersize=4,
                 label='Caminhada')
        plt.plot(self.semanas, self.af_moderada_5_semanas_ipaq, color='#FF8C00', linestyle='--', marker='o',
                 markersize=4, label='Atividade física moderada')
        plt.plot(self.semanas, self.af_vigorosa_5_semanas_ipaq, color='#FF0000', linestyle='--', marker='o',
                 markersize=4, label='Atividade física vigorosa')
    ...
    def CriarGrafico_DominiosIpaq(self):
        ...
        plt.plot(self.semanas, self.af_remunerada_5_semanas_ipaq_dom, color='#000000', linestyle='-', marker='o',
                 markersize=4, label='Remunerada')
        plt.plot(self.semanas, self.af_transporte_5_semanas_ipaq_dom, color='#4F4F4F', linestyle='--', marker='o',
                 markersize=4, label='Transporte')
        plt.plot(self.semanas, self.af_domestica_5_semanas_ipaq_dom, color='#A9A9A9', linestyle='--', marker='o',
                 markersize=4, label='Doméstica')
        plt.plot(self.semanas, self.af_lazer_5_semanas_ipaq_dom, color='#DCDCDC', linestyle='-', marker='o',
                 markersize=4, label='Lazer')
        #plt.title('Atividade física (autorrelato) ao longo das 3 semanas', fontsize=12)
        plt.ylabel('Tempo (minutos)')
    ...
    def TelaResultados(self):
        janela_resultados = customtkinter.CTk()
        janela_resultados.geometry("300x300")

        def fechar_tela_resultados():
